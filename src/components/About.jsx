    ...
    <section id="about">
      <div className={`mx-auto grid w-full max-w-[1120px] gap-8 px-4 py-10 md:px-6 md:py-14 ${showImageArea ? "md:grid-cols-2 md:items-center md:gap-12" : ""}`}>
        <div className="flex flex-col gap-4">
          ...
          <p className="max-w-[60ch] text-arang">Jajanan Bu Sum adalah usaha jajanan rumahan yang menerima pesanan untuk berbagai kebutuhan acara. Jajanan dibuat sesuai pesanan, sehingga dapat disiapkan untuk kegiatan seperti arisan, syukuran, rapat desa, maupun acara berkumpul lainnya.</p>

          <p className="max-w-[60ch] text-arang">Melayani pesanan untuk wilayah Giriwoyo dan sekitarnya. Lihat pilihan jajanan kami, lalu hubungi Bu Sum melalui WhatsApp untuk menanyakan harga, minimal pesanan, dan kebutuhan acaranya.</p>
        </div>
